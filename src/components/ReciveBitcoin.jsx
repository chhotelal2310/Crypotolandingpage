          ...
          <div className="bitCoinScoreContainer">
            <div className="gridContainer">
              <div className="gridContainerItem">
                <div className="half-circle half-circle1">
                  <span>100%</span>
                </div>
              </div>
            ...
            <div className="gridContainer">
              <div className="gridContainerItem">
                <div className="half-circle half-circle2">
                  <span>71%</span>
                </div>
              </div>
            ...
            <div className="gridContainer">
              <div className="gridContainerItem">
                <div className="half-circle half-circle3 ">
                  <span>71%</span>
                </div>
              </div>
            ...
            <div className="gridContainer">
              <div className="gridContainerItem">
                <div className="half-circle half-circle4">
                  <span>100%</span>
                </div>
              </div>
