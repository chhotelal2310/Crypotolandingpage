...
const CryptoHeadPersionDetail = () => {
  let data = [
    ...
    },
    {
      ...
      decription:
        "Eget nunc scelerisque viverra mauris. Blandit aliquam etiam erat in velit scelerisque in. Turpis aliquam in eu mi bibendum neque erat.",
    },
    {
      id: "3",
      url: profile_Image2,
      ...
      decription:
        "Blandit nunc scelerisque viverra mauris. nonue eirmod aliquam etiam erat in velit scelerisque in. Turpis  aliquam in eu mi bibendum erat",
    },
    {
      id: "4",
      url: profile_Image4,
      ...
      subtile: "IT CLIENT MANAGER",
      decription:
        "Turpis ipsum dolor sit amet, consetet sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam.",
    },
  ];
  ...
  return (
    <>
      {data.map((item) => {
        return (
          <div key={item.id} className="GridHeadPersionBodyContainer">
